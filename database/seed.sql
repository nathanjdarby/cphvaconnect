-- CPHVA Connect Database Seed Data
...
('user1', 'Attendee User', 'attendee@example.com', 'attendee', true, false, 'Passionate about public health and attending the CPHVA Conference!', 'https://placehold.co/100x100.png?text=AU', NULL),
('admin1', 'Admin User', 'admin@example.com', 'admin', true, true, 'Ensuring a smooth conference experience for all.', 'https://placehold.co/100x100.png?text=AD', NULL),
('organiser1', 'Organiser User', 'organiser@example.com', 'organiser', true, true, 'Organising the CPHVA Annual Conference.', 'https://placehold.co/100x100.png?text=OU', NULL);
...
('event-day1-1', 'Registration & Exhibitor Visiting', 'Time for registration and to visit the exhibition hall.', '2025-11-05 09:00:00', '2025-11-05 09:30:00', 'loc-bcec-exhibit', false),
('event-day1-2', 'Welcome Address', 'Welcome by CPHVA Executive Chair Janet Taylor.', '2025-11-05 09:30:00', '2025-11-05 09:40:00', 'loc-bcec-main', false),
('event-day1-3', 'Unite Opening Address', 'Opening address by Dominic Hook, National Sector Coordinator for Public Services, Unite.', '2025-11-05 09:40:00', '2025-11-05 10:00:00', 'loc-bcec-main', false),
('event-day1-4', 'PANEL: Chief Nursing Officers on CP Workforce Challenges', 'An informative and interactive session from the UK''s most senior nursing leaders, including extended Q&As with delegates.', '2025-11-05 10:00:00', '2025-11-05 11:00:00', 'loc-bcec-main', false),
('event-day1-5', 'Refreshment Break', 'Networking and exhibition viewing.', '2025-11-05 11:00:00', '2025-11-05 11:30:00', 'loc-bcec-exhibit', false),
('event-day1-6', 'The Role of the Professional Nurse Advocate', 'Enhancing Practice: Part 1. Presented by Queen''s Nurse Jo Bettison.', '2025-11-05 11:30:00', '2025-11-05 12:00:00', 'loc-bcec-main', false),
('event-day1-7', 'The Rise of Social Prescribing', 'Enhancing Practice: Part 2. Presented by Queen''s Nurse Helen Burke.', '2025-11-05 12:00:00', '2025-11-05 12:30:00', 'loc-bcec-main', false),
('event-day1-8', 'Lunch Break', 'Networking and exhibition viewing.', '2025-11-05 12:30:00', '2025-11-05 13:30:00', 'loc-bcec-dining', false),
('event-day1-9', 'Born in Bradford', 'Internationally recognised research project on what keeps families happy and healthy. Presented by Lydia Gunning.', '2025-11-05 13:30:00', '2025-11-05 14:10:00', 'loc-bcec-main', false),
('event-day1-10', 'Innovative Projects: Improving Education Infrastructure', 'Supporting SCPHN workforce recruitment and quality post-registration teaching. Presented by Jenny Gilmour and Nicky Brown.', '2025-11-05 14:10:00', '2025-11-05 14:40:00', 'loc-bcec-main', false),
('event-day1-11', 'NMC Important Updates', 'Presented by Elaine Robinson.', '2025-11-05 14:40:00', '2025-11-05 15:10:00', 'loc-bcec-main', false),
('event-day1-12', 'Refreshment Break', 'Networking and exhibition viewing.', '2025-11-05 15:10:00', '2025-11-05 15:40:00', 'loc-bcec-exhibit', false),
('event-day1-13', 'Vaccine Update', 'Latest developments in vaccines. Presented by Professor Helen Bedford.', '2025-11-05 15:40:00', '2025-11-05 16:10:00', 'loc-bcec-main', false),
('event-day1-14', 'Positive Culture', 'Presented by Ethel Rodrigues.', '2025-11-05 16:10:00', '2025-11-05 16:30:00', 'loc-bcec-main', false),
('event-day1-15', 'The CPHVA Education and Development Trust Update', 'Update on MacQueen Awards and charity work. Presented by Kitty Lamb.', '2025-11-05 16:30:00', '2025-11-05 16:45:00', 'loc-bcec-main', false),
('event-day1-16', 'Unite Health Update', 'Presented by Richard Munn.', '2025-11-05 16:45:00', '2025-11-05 16:55:00', 'loc-bcec-main', false),
('event-day1-17', 'Conference Day 1 Close', 'Closing remarks by CPHVA Executive Chair Janet Taylor.', '2025-11-05 17:00:00', '2025-11-05 17:15:00', 'loc-bcec-main', false),
('event-day1-18', 'Unite-CPHVA Excellence Awards Presentation and Dinner Buffet', 'Awards presentation (starts 7:30 PM) and networking dinner.', '2025-11-05 19:00:00', '2025-11-05 22:00:00', 'loc-bcec-dining', false);

-- Insert Schedule Events (Day 2: Thursday, November 6th, 2025)
INSERT INTO schedule_events (id, title, description, start_time, end_time, location_id, offer_downloads) VALUES
('event-day2-1', 'Registration & Exhibitor Visiting (Day 2)', 'Time for registration and to visit the exhibition hall.', '2025-11-06 08:40:00', '2025-11-06 09:00:00', 'loc-bcec-exhibit', false),
('event-day2-2', 'Welcome (Day 2)', 'Welcome by CPHVA Executive Chair Janet Taylor.', '2025-11-06 09:00:00', '2025-11-06 09:10:00', 'loc-bcec-main', false),
('event-day2-3', 'PANEL: Pressing issues facing clients across the UK', 'Senior practitioners and academics share insights on challenges and opportunities facing families. (Including extended Q&As with delegates)', '2025-11-06 09:10:00', '2025-11-06 10:20:00', 'loc-bcec-main', false),
('event-day2-4', 'Innovative projects 2: Neonatal tests for diverse newborns', 'Research and practice updates on neonatal tests for Black, Asian and ethnic minority newborns.', '2025-11-06 10:20:00', '2025-11-06 11:00:00', 'loc-bcec-main', false),
('event-day2-5', 'Refreshment Break (Day 2)', 'Networking and exhibition viewing.', '2025-11-06 11:00:00', '2025-11-06 11:30:00', 'loc-bcec-exhibit', false),
('event-day2-6', 'CALL FOR PAPERS presentations', 'Celebrating Innovation in Practice: Successful submissions are presented to delegates. Includes: Understanding mothers'' coping mechanisms (Diana Skibniewski-Woods), Experiences of parents with learning disabilities (Zoe Rawlence; Jo Sumner), Developing research capacity of SCPHNs (O-19 Research Network), Improving uptake of childhood immunisations (Sophie Ames).', '2025-11-06 11:30:00', '2025-11-06 12:45:00', 'loc-bcec-main', false),
('event-day2-7', 'Lunch Break (Day 2)', 'Networking and exhibition viewing.', '2025-11-06 12:45:00', '2025-11-06 13:45:00', 'loc-bcec-dining', false),
('event-day2-8', 'Nick Robin Memorial Lecture/ Keynote speaker', 'Rukshana Kapasi, Director of health at Barnardo''s, will discuss major new projects and the need for more co-ordinated services due to workforce issues.', '2025-11-06 13:45:00', '2025-11-06 14:30:00', 'loc-bcec-main', false),
('event-day2-9', 'Looking after number one', 'Health and wellbeing toolkit to improve practitioner mental health. Interactive session with Stephen Hamilton.', '2025-11-06 14:30:00', '2025-11-06 15:20:00', 'loc-bcec-main', false),
('event-day2-10', 'A special finale to celebrate the professions', 'An interactive performance by the Choir with No Name, a charity supporting those affected by homelessness.', '2025-11-06 15:20:00', '2025-11-06 15:35:00', 'loc-bcec-main', false),
('event-day2-11', 'Conference Close', 'Closing remarks by CPHVA Executive Chair Janet Taylor.', '2025-11-06 15:45:00', '2025-11-06 16:00:00', 'loc-bcec-main', false);
...
('ticket-admin1-gen', 'admin1', 'Admin User', 'Unite-CPHVA Annual Professional Conference 2025', 'General Admission', 75.00, '2025-10-01 00:00:00', 'ADMIN1-TICKET1-CPHVA2025-GENERAL', false, NULL),
('ticket-user1-gen', 'user1', 'Attendee User', 'Unite-CPHVA Annual Professional Conference 2025', 'Unite Member Rate', 60.00, '2025-10-02 00:00:00', 'USER1-TICKET1-CPHVA2025-UNITE', false, NULL);

-- Insert Polls
INSERT INTO polls (id, question, is_open, created_at) VALUES
('poll-nov25-1', 'Which session are you most looking forward to on Day 1?', true, '2025-11-05 08:00:00');
...
('settings', 'Unite-CPHVA Annual Professional Conference 2025', true, '0 0% 94%', '0 0% 20%', '166 29% 40%', '283 49% 60%');
