    ...
    <div className="container mx-auto p-6 max-w-4xl">
      ...
      <div className="grid gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              <p><strong>NEXT_PUBLIC_USE_REAL_DATABASE:</strong> {process.env.NEXT_PUBLIC_USE_REAL_DATABASE}</p>
              <p><strong>USE_REAL_DATABASE:</strong> {process.env.USE_REAL_DATABASE}</p>
            </div>
          </CardContent>
        </Card>
      </div>
