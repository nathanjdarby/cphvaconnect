            ...
            <div className="overflow-x-auto border rounded-md">
              <Table>
                <TableCaption>
                  ...
                  {filteredAndSortedUsers.length} user(s) displayed.
                </TableCaption>
                <TableHeader>
                  <TableRow>
                      ...
                      <TableCell>
                        <Select
                          ...
                          onValueChange={(newRole) =>
                            handleRoleChange(u.id, newRole as UserRole)
                          }
                        >
                      ...
                      <TableCell className="text-right space-x-2 whitespace-nowrap">
                        <Button
                          ...
                          disabled={
                            user?.id === u.id ||
                            (u.role === "admin" &&
                              allUsers.filter((usr) => usr.role === "admin")
                                .length <= 1)
                          }
                        >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              user and all their associated tickets.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
