    ...
    <div className="space-y-6">
      <Card className="shadow-lg">
        <CardHeader className="flex flex-row items-center justify-between">
          <div className="space-y-1.5">
            ...
            <CardDescription>
              Create, view results, and manage conference polls.
            </CardDescription>
          </div>
        ...
        <CardContent>
          {sortedPolls.length === 0 ? (
            <p className="text-muted-foreground text-center py-8">
              No polls created yet. Create one to get started!
            </p>
          ) : (
                  ...
                  <Card key={poll.id} className="shadow-md">
                    <CardHeader>
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <CardDescription>
                            Created:{" "}
                            {format(parseISO(poll.createdAt), "MMM d, yyyy p")}{" "}
                            -
                            <span
                              className={`ml-2 font-semibold ${
                                poll.isOpen ? "text-green-600" : "text-red-600"
                              }`}
                            >
                    ...
                    <CardFooter className="border-t pt-3 flex justify-end">
                      <Button
                        variant="destructive"
                        size="sm"
                        onClick={() => handleDeleteConfirmation(poll.id)}
                      >
      ...
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        <SheetContent className="sm:max-w-xl overflow-y-auto">
          ...
          <PollForm isOpen={isSheetOpen} setIsOpen={setIsSheetOpen} />
        </SheetContent>
      </Sheet>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              poll and all its votes.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={executeDeletePoll}>
              Continue
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
